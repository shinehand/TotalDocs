...
Date: 2026-04-17
Scope: `/Users/shinehandmac/Downloads` 원본 샘플 + `docs/hwp-spec/` 공식 형식 문서 + 현재 `HWP 엔진` 기반 뷰어
...
- `고엽제등록신청서`는 두 벌이다.
  - 짧은 양식:
    ...
    - Repo mirror: `/Users/shinehandmac/Github/ChromeHWP/output/playwright/inputs/goyeopje.hwp`
  ...
  - 2024 일체본:
    ...
    - Repo mirror: `/Users/shinehandmac/Github/ChromeHWP/output/playwright/inputs/goyeopje-full-2024.hwp`
...
- 자동감사 스크립트를 현행 뷰어 경로에 맞게 전면 갱신했다.
  - 파일: `/Users/shinehandmac/Github/ChromeHWP/scripts/verify_samples.mjs`
  - 기준:
    - `http://127.0.0.1:4173/pages/viewer.html?hwpUrl=...`
    - 상태바 `쪽/구역`
    - 렌더된 실제 `.hwp-page canvas` 개수
    - 문서 내 키워드 검색(`window.HwpWasmRenderer.searchText`)
    - 첫 쪽부터 마지막 쪽까지의 페이지 순회
    - 콘솔 오류 수집
- 결과 산출물:
  - `/Users/shinehandmac/Github/ChromeHWP/output/playwright/verify-samples-report.json`
...
- `/Users/shinehandmac/Github/ChromeHWP/js/hwp-wasm-renderer.js`
  - WASM 렌더 진입점
  - 웹 폰트 측정 경로
