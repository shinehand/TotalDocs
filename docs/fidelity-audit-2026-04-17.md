...
Date: 2026-04-17
Scope: `/Users/shinehandmac/Downloads` 원본 샘플 + `docs/hwp-spec/` 공식 형식 문서 + 현재 ChromeHWP JS 파서/DOM 렌더러 기반 뷰어
...
- `/Users/shinehandmac/Github/ChromeHWP/js/hwp-renderer.js`
  - DOM 렌더 진입점
  - 웹 폰트 및 표/개체 배치 경로
